...
[^5]: NextDNS can provide insights and logging features on an opt-out basis. You can choose retention times and log storage locations for any logs you choose to keep. Note that this somewhat contradicts the service’s privacy policy, which states that “If not specifically requested by the user, no data is logged.” [https://nextdns.io/privacy](https://nextdns.io/privacy)
