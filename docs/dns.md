...
[^5]: When used with a user account NextDNS will enable insights and logging features by default. You can choose retention time and log storage location for any logs you choose to keep, or disable logs altogether. If used without a user account, no logs are kept. [https://nextdns.io/privacy](https://nextdns.io/privacy)
