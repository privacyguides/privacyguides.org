...
- Your IP address and that of the contacts you're communicating with may be exposed if you do not use the software in conjunction with a [VPN](../vpn.md) or [Tor](../alternative-networks.md#tor). Many countries have some form of mass surveillance and/or metadata retention.
