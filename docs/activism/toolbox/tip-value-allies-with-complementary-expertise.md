...
![Colored banner with four icons on it, a toolbox, a hammer, a circle with half dark and half light, and a wrench.](../images/banners/banner-toolbox-tip-complement.webp){align=top}
...
If you organize an event or hire people, make sure to compensate fairly all your contributors. Pay special attention to make sure people with different expertises or demographics aren't always the ones who have to work as volunteers.
...
This is something that is *incredibly* valuable to fight for privacy rights, together.
