...
[^2]: As of June 2026, [Brave](https://brave.com/blog/brave-shields-manifest-v3/) and [Opera](https://xcancel.com/Opera_Security/status/2066543496001888753) have committed to maintain MV2 support for the foreseeable future. Be aware that any Chromium-based browser that still supports MV2 extensions is now responsible for maintaining and securing the infrastructure as Google progressively removes MV2 support from the codebase.
