...
!!! tip
    ...
    Les applications ne peuvent pas obtenir un accès au root et n'ont accès qu'aux ressources du système que vous leur accordez. Les systèmes d'exploitation de bureau sont généralement à la traîne en ce qui concerne le sandboxing. Chrome OS possède des propriétés de sandboxing similaires à celles d'Android, et macOS possède un contrôle complet des permissions du système et un sandboxing optionnel (pour les développeurs) pour les applications, mais ces systèmes d'exploitation transmettent des informations d'identification à leurs fabricants respectifs. Linux a tendance à ne pas soumettre d'informations aux fournisseurs de systèmes, mais il a une mauvaise protection contre les exploits et les applications malveillantes. Ce problème peut être quelque peu atténué avec des distributions spécialisées qui font un usage intensif des machines virtuelles ou des conteneurs, comme Qubes OS.
...
!!! note "Note sur le chiffrement basé sur le web"
    ...
    Dans la pratique, l'efficacité des différentes mises en œuvre du chiffrement de bout en bout varie. Des applications telles que [Signal](../time-communication.md#signal) s'exécutent nativement sur votre appareil, et chaque copie de l'application est la même sur différentes installations. Si le fournisseur de services venait à ouvrir une porte dérobée dans son application pour tenter de voler vos clés privées, cela pourrait être détecté ultérieurement par rétro-ingénierie.
...
La surveillance de masse est un effort visant à surveiller une grande partie ou la totalité d'une population donnée. Elle fait souvent référence à des programmes gouvernementaux tels que ceux [divulgués par Edward Snowden en 2013](https://fr.wikipedia.org/wiki/R%C3%A9v%C3%A9lations_d%27Edward_Snowden).

Les gouvernements invoquent souvent les programmes de surveillance de masse comme étant nécessaires pour combattre le terrorisme et prévenir la criminalité. Cependant, en violation des droits de l'homme, elle est le plus souvent utilisée pour cibler de manière disproportionnée les minorités et les dissidents politiques, entre autres.

    Si vous souhaitez en savoir plus sur les méthodes de surveillance et la manière dont elles sont mises en œuvre dans votre ville, vous pouvez également consulter l'[Atlas de la Surveillance] (https://atlasofsurveillance.org/) de l'[Electronic Frontier Foundation] (https://www.eff.org/).

Governments often justify mass surveillance programs as necessary means to combat terrorism and prevent crime. citation "ACLU: [*The Privacy Lesson of 9/11: Mass Surveillance is Not the Way Forward*](https://www.aclu.org/news/national-security/the-privacy-lesson-of-9-11-mass-surveillance-is-not-the-way-forward)"

!!! citation "ACLU : [*La leçon du 11 septembre en matière de vie privée : La surveillance de masse n'est pas la voie à suivre*](https://www.aclu.org/news/national-security/the-privacy-lesson-of-9-11-mass-surveillance-is-not-the-way-forward)"

    S'il est relativement facile de se soustraire à la censure, il peut être très problématique de dissimuler aux censeurs le fait que vous contourner au système de censure. Vous devez prendre en compte les aspects du réseau que votre adversaire peut observer, et si vous avez une possibilité de déni plausible pour vos actions.

Sur Internet, vous pouvez être surveillés par divers moyens :
...
- L'empreinte digitale de votre navigateur ou de votre appareil
...
> Le capitalisme de surveillance est un système économique centré sur la capture et la marchandisation des données personnelles dans le but essentiel de faire du profit.[^2]

La meilleure façon de garantir la confidentialité de vos données est tout simplement de ne pas les mettre en ligne. La suppression des informations que vous trouvez sur vous-même en ligne est l'une des meilleures premières mesures que vous pouvez prendre pour retrouver votre vie privée. La meilleure protection contre la collecte de données par les entreprises est de chiffrer ou d'obscurcir vos données dans la mesure du possible, afin qu'il soit difficile pour les différents fournisseurs de corréler les données entre elles et d'établir un profil sur vous.

Sur les sites où vous partagez des informations, il est très important de vérifier les paramètres de confidentialité de votre compte pour limiter la diffusion de ces données. Par exemple, si vos comptes disposent d'un "mode privé", activez-le pour vous assurer que votre compte n'est pas indexé par les moteurs de recherche et qu'il ne puisse pas être consulté par des personnes que vous n'avez pas autorisées au préalable. La meilleure protection contre la collecte de données par les entreprises est de chiffrer ou d'obscurcir vos données dans la mesure du possible, afin qu'il soit difficile pour les différents fournisseurs de corréler les données entre elles et d'établir un profil sur vous.
...
- [Consultez notre guide sur la suppression de compte :hero-arrow-circle-right-fill:](account-deletion.md)

La censure en ligne peut être exercée à de divers degrés par des acteurs tels que des gouvernements totalitaires, des administrateurs réseaux et des fournisseurs de services qui cherchent à contrôler la parole de leurs utilisateurs et les informations auxquelles ils peuvent accéder. Ces efforts pour filtrer Internet seront toujours incompatibles avec les idéaux de la liberté d'expression.

La censure sur les plateformes privées est de plus en plus courante, car des plateformes comme Twitter et Facebook cèdent à la demande du public, aux pressions du marché et à celles des agences gouvernementales. Les pressions gouvernementales peuvent prendre la forme de demandes secrètes adressées aux entreprises, comme la Maison Blanche [demandant le retrait](https://www.nytimes.com/2012/09/17/technology/on-the-web-a-fine-line-on-free-speech-across-globe.html) d'une vidéo provocante sur YouTube ; ou manifestes, comme le gouvernement chinois exigeant des entreprises qu'elles adhèrent à un régime de censure strict.
...
[^2]: Wikipédia : [Capitalisme de surveillance](https://fr.wikipedia.org/wiki/%C3%89conomie_de_la_surveillance)
[^3]: Wikipédia : [Capitalisme de surveillance](https://fr.wikipedia.org/wiki/%C3%89conomie_de_la_surveillance)
