...
The first task a person should do when taking steps to protect their privacy and security is make a threat model.

## Defining a Threat

To make a threat model, we must first define a threat: The people who you want to protect some or all of your data from.
