...
- ![Snowflakeלוגו](assets/img/browsers/snowflake.svg#only-light){ .twemoji }![Snowflake logo](assets/img/browsers/snowflake-dark.svg#only-dark){ .twemoji } [Snowflake](tor.md#snowflake) (1)
...
[מידע נוסף :material-arrow-right-drop-circle:](desktop-browsers.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](desktop-browsers.md#additional-resources)
...
[מידע נוסף :material-arrow-right-drop-circle:](mobile-browsers.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](mobile-browsers.md#adguard)
...
[מידע נוסף :material-arrow-right-drop-circle:](android.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](android.md#general-apps)
...
[מידע נוסף :material-arrow-right-drop-circle:](desktop.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](router.md)
...
- ![Cryptee לוגו](assets/img/cloud/cryptee.svg#only-light){ .twemoji }![Cryptee logo](assets/img/cloud/cryptee-dark.svg#only-dark){ .twemoji } [Cryptee](cloud.md#cryptee)
- ![Nextcloud לוגו](assets/img/cloud/nextcloud.svg){ .twemoji } [Nextcloud (Self-Hostable)](cloud.md#nextcloud)
- ![Proton Drive לוגו](assets/img/cloud/protondrive.svg){ .twemoji } [Proton Drive](cloud.md#proton-drive)

</div>

[מידע נוסף :material-arrow-right-drop-circle:](cloud.md)

### DNS

#### ספקי DNS

אנו [ממליצים](dns.md#recommended-providers) מספר שרתי DNS מוצפנים המבוססים על מגוון קריטריונים, כגון [Mullvad](https://mullvad.net/en/help/dns-over-https-and-dns-over-tls) ו [Quad9](https://quad9.net/) בין היתר. מומלץ לקרוא את הדפים שלנו ב - DNS לפני בחירת ספק. במקרים רבים, שימוש בספק DNS חלופי אינו מומלץ.

[מידע נוסף :material-arrow-right-drop-circle:](dns.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](dns.md#encrypted-dns-proxies)
...
[מידע נוסף :material-arrow-right-drop-circle:](dns.md#self-hosted-solutions)
...
[מידע נוסף :material-arrow-right-drop-circle:](email.md)

#### שירותי כינויי דוא"ל

<div class="grid cards" markdown>

- ![AnonAddy לוגו](assets/img/email/anonaddy.svg#only-light){ .twemoji }![AnonAddy logo](assets/img/email/anonaddy-dark.svg#only-dark){ .twemoji } [AnonAddy](email.md#anonaddy)
- ![SimpleLogin לוגו](assets/img/email/simplelogin.svg){ .twemoji } [SimpleLogin](email.md#simplelogin)

</div>

[מידע נוסף :material-arrow-right-drop-circle:](email.md#email-aliasing-services)
...
[מידע נוסף :material-arrow-right-drop-circle:](email.md#self-hosting-email)
...
- ![Startpage לוגו](assets/img/search-engines/startpage.svg#only-light){ .twemoji }![Startpage לוגו](assets/img/search-engines/startpage-dark.svg#only-dark){ .twemoji } [Startpage](search-engines.md#startpage)

</div>

[מידע נוסף :material-arrow-right-drop-circle:](search-engines.md)
...
### סנכרון לוח שנה/אנשי קשר

<div class="grid cards" markdown>

- ![Tutanota לוגו](assets/img/calendar-contacts/tutanota.svg){ .twemoji } [Tutanota](calendar-contacts.md#tutanota)
- ![Proton Calendar לוגו](assets/img/calendar-contacts/proton-calendar.svg){ .twemoji } [Proton Calendar](calendar-contacts.md#proton-calendar)
...
[מידע נוסף :material-arrow-right-drop-circle:](data-redaction.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](email-clients.md)

### תוכנת הצפנה

??? מידע "הצפנת דיסק מערכת הפעלה"

    להצפנת כונן מערכת ההפעלה שלך, אנו ממליצים בדרך כלל להשתמש בכל כלי הצפנה שמערכת ההפעלה שלך מספקת, בין אם זה **BitLocker** ב - Windows, ** FileVault ** ב - macOS, או **LUKS** ב - Linux. כלים אלה כלולים במערכת ההפעלה ובדרך כלל משתמשים באלמנטים של הצפנת חומרה כגון TPM שתוכנת הצפנה אחרת בדיסק מלא כמו VeraCrypt לא. VeraCrypt עדיין מתאים לדיסקים שאינם מופעלים במערכת כגון כוננים חיצוניים, במיוחד כוננים שניתן לגשת אליהם ממערכות הפעלה מרובות.
    
    [מידע נוסף :material-arrow-right-drop-circle:](encryption.md##operating-system-included-full-disk-encryption-fde)
...
[מידע נוסף :material-arrow-right-drop-circle:](encryption.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](encryption.md#openpgp)
...
[מידע נוסף :material-arrow-right-drop-circle:](file-sharing.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](frontends.md)

### כלים לאימות רב - גורמי
...
[מידע נוסף :material-arrow-right-drop-circle:](multi-factor-authentication.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](news-aggregators.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](notebooks.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](passwords.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](productivity.md)
...
[מידע נוסף :material-arrow-right-drop-circle:](real-time-communication.md)

### קליינטים הזרמת וידאו
...
[מידע נוסף :material-arrow-right-drop-circle:](video-streaming.md)
