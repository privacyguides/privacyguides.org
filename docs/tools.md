...
- ![Apple Health logo](assets/img/health-and-wellness/apple-health.webp#only-dark){ .twemoji loading=lazy } ![Apple Health logo](assets/img/health-and-wellness/apple-health-dark.webp#only-light){ .twemoji loading=lazy } [Apple Health Records](health-and-wellness.md#apple-health-records)
