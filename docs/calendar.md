...
Unfortunately, as of January 2024 Proton has [still](https://discuss.privacyguides.net/t/proton-calendar-is-not-open-source-mobile/14656/8) not released the source code for their mobile Calendar app on Android or iOS and only the the former has been [audited](https://drive.proton.me/urls/VGXYGFPE70#txnu5vF12qQU). Proton Calendar's web client is open source, however, and has been [audited](https://drive.proton.me/urls/VGXYGFPE70#txnu5vF12qQU).
