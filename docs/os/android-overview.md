...
A **device controller** app such as [Shelter](../docs/android.md#shelter) is required to create a Work Profile without an enterprise MDM, unless you're using a custom Android OS which includes one.
