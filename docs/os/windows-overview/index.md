...
---
![Windows logo](/en/assets/img/windows/windows.svg){ align=right }

**Microsoft Windows** is a proprietary operating system shipped with many computers by default. The following guides aim to provide some ways to improve privacy and reduce the default telemetry and data stored by disabling some unnecessary features.
...
- Adding cloud-based AI features to many areas within Windows and various Microsoft Apps.
