...
!!! aanbeveling
    ...
    **ExifCleaner** is een freeware, open-source app met een grafische interface die [ExifTool](https://exiftool.org) gebruikt om Exif-metadata te verwijderen uit afbeeldingen, video's en PDF-documenten met behulp van een eenvoudige drag-and-drop interface. Het ondersteunt multi-core batchverwerking en donkere modus.
    
    [:octicons-home-16: Homepage](https://exifcleaner.com){ .md-button .md-button--primary }
    [:octicons-info-16:](https://github.com/szTheory/exifcleaner#readme){ .card-link title=Documentatie}
    [:octicons-code-16:](https://github.com/szTheory/exifcleaner){ .card-link title="Broncode" }
