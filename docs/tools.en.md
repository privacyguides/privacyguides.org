...
- ![Brave logo](assets/img/browsers/brave.svg){ .twemoji } [Brave (Android)](browsers.md#brave-android)
...
- ![Send logo](assets/img/file-sharing-sync/firefox-send.svg){ .twemoji } [Firefox Send Fork](file-sharing.md#firefox-send-fork)
