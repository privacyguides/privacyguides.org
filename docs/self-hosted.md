...
- [**Email Aliasing**](email-aliasing.md): [Addy.io](email-aliasing.md#addyio) [:material-book-open-page-variant:](<https://addy.io/self-hosting> "Admin Documentation") and [SimpleLogin](email-aliasing.md#simplelogin) [:material-book-open-page-variant:](<https://github.com/simple-login/app#prerequisites> "Admin Documentation")
- [**Photo Management**](photo-management.md): [Ente Photos](photo-management.md#ente-photos) [:octicons-book-24:](https://help.ente.io/self-hosting){ .card-link title="Admin Documentation" } and [Stingle](photo-management.md#stingle) [:octicons-book-24:](https://stingle.org/server){ title="Admin Documentation" }
