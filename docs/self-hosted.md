...
- [**Photo Management**](photo-management.md): [Ente Photos](photo-management.md#ente-photos) [:material-book-information-variant:](https://help.ente.io/self-hosting){ .card-link title="Admin Documentation" } and [Stingle](photo-management.md#stingle) [:octicons-info-24:](https://stingle.org/server){ .card-link title="Admin Documentation" }
