...
- [**Real Time Communication**](real-time-communication.md): [SimpleX Chat](real-time-communication.md#simplex-chat) [:octicons-book-24:](<https://simplex.chat/docs/server.html> "Admin Documentation") and [Element](real-time-communication.md#element) [:octicons-book-24:](<https://element-hq.github.io/synapse/latest> "Admin Documentation")
