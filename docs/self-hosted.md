...
- [**Email Aliasing**](email-aliasing.md): [Addy.io](email-aliasing.md#addyio) [:octicons-log-24:](https://addy.io/self-hosting){ .card-link title="Admin Documentation" } and [SimpleLogin](email-aliasing.md#simplelogin) [:octicons-log-24:](https://github.com/simple-login/app#prerequisites){ .card-link title="Admin Documentation" }
- [**Photo Management**](photo-management.md): [Ente Photos](photo-management.md#ente-photos) [:octicons-log-24:](https://help.ente.io/self-hosting){ .card-link title="Admin Documentation" } and [Stingle](photo-management.md#stingle) [:octicons-log-24:](https://stingle.org/server){ .card-link title="Admin Documentation" }
- [**Document Collaboration**](document-collaboration.md): [Cryptpad](document-collaboration.md#cryptpad) [:octicons-log-24:](https://docs.cryptpad.org/en/admin_guide/index.html){ .card-link title="Admin Documentation" }
- [**Language Tools**](language-tools.md): [LanguageTool](language-tools.md#languagetool) [:octicons-log-24:](https://dev.languagetool.org/http-server){ .card-link title="Admin Documentation" }
- [**News Aggregators**](news-aggregators.md): [Miniflux](news-aggregators.md#miniflux) [:octicons-log-24:](https://miniflux.app/docs/index.html#administration-guide){ .card-link title="Admin Documentation" }
- [**Pastebins**](pastebins.md): [Privatebin](pastebins.md#privatebin) [:octicons-log-24:](https://github.com/PrivateBin/PrivateBin/blob/master/doc/Installation.md){ .card-link title="Admin Documentation" } and [Paaster](pastebins.md#paaster) [:octicons-log-24:](https://github.com/WardPearce/paaster#deployment){ .card-link title="Admin Documentation" }
- [**Real Time Communication**](real-time-communication.md): [SimpleX Chat](real-time-communication.md#simplex-chat) [:octicons-log-24:](https://simplex.chat/docs/server.html){ .card-link title="Admin Documentation" } and [Element](real-time-communication.md#element) [:octicons-log-24:](https://element-hq.github.io/synapse/latest){ .card-link title="Admin Documentation" }
