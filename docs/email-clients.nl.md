...
!!! We raden het aan omdat er maar weinig keuzes zijn voor e-mailclients op iOS die PGP E2EE ondersteunen.
...
Canary Mail is closed-source. aanbeveling
...
!!! aanbeveling
    ...
    **Kontact** is een applicatie voor het beheren van persoonlijke informatie (PIM) van het [KDE](https://kde.org) project. Het biedt een mail client, adresboek, organizer en RSS client.
...
!!! aanbeveling
    ...
    **Mailvelope** is een browserextensie waarmee versleutelde e-mails kunnen worden uitgewisseld volgens de OpenPGP-encryptiestandaard.
    ...
    [:octicons-info-16:](https://mailvelope.com/faq){ .card-link title=Documentatie}
    [:octicons-code-16:](https://github.com/mailvelope/mailvelope){ .card-link title="Broncode" }
...
!!! aanbeveling
    ...
    NeoMutt is een open-source opdrachtregel mail lezer (of MUA) voor Linux en BSD. Het is een vork van [Mutt](https://en.wikipedia.org/wiki/Mutt_(email_client)) met toegevoegde mogelijkheden.
