...
!!! info
    ...
    ![Logotipo de KeepassXC](assets/img/password-management/keepassxc.svg){ align=right }
...
!!! recomendación
    ...
    ![Logotipo de Joplin](/assets/img/password-management/bitwarden.svg){ align=right }
